...
, function(t, e, n) {
    var r = function(t) {
        ...
        return v.prototype = x.constructor = b,
        b.constructor = v,
...
, function(t, e) {
    !function(t) {
        ...
        function y(t) {
            this.map = {},
            t instanceof y ? t.forEach((function(t, e) {
                this.append(e, t)
            }
...
, function(t, e, n) {
    ...
    var b = function() {
        ...
        (n = [{
            key: "handleClick",
            value: function(t) {
                t.target == this.body && (t.stopPropagation(),
                this.hide())
            }
        }, {
            key: "show",
            ...
            value: function(t) {
                ...
                ,
                r = function() {
                    i.body.style.display = "none",
                    i.body.dispatchEvent(new CustomEvent("ckjs:overlay:hide",{
                        bubbles: !0,
                        detail: t
                    }))
                }
    ...
    function w(t, e, n, r) {
        ...
        for (var i = 0; i < e.length; i++)
            t.addEventListener("click", (function(t) {
                for (var n = t.target; null != n && (n == document || !g(n, e)); )
                    n = n.parentNode;
                n && r(t, n)
            }
            ))
        ...
        var n = !1
          , r = function r() {
            ...
            window.requestAnimationFrame((function() {
                (window.scrollY + window.innerHeight) / window.document.body.scrollHeight * 100 > t && (e(),
        ...
        function t(e) {
            ...
            this.body = function(t) {
                ...
                return d("div", {
                    ...
                    "aria-label": "Close"
                }, [(e = '<svg viewBox="0 0 24 24" style="margin: auto; font-size: inherit;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"><path d="M7.53 6.47a.75.75 0 0 0-1.06 1.06L10.94 12l-4.47 4.47a.75.75 0 1 0 1.06 1.06L12 13.06l4.47 4.47a.75.75 0 1 0 1.06-1.06L13.06 12l4.47-4.47a.75.75 0 0 0-1.06-1.06L12 10.94 7.53 6.47z"></path></svg>',
            ...
            w(this.body, "[data-formkit-close]", 0, (function(t) {
                t.stopPropagation(),
                n.hide()
            }
            ))
    ...
    var L = function() {
        function t(e) {
            ...
            this.show = function() {
                ...
                n.form.resize(),
                n.form.visit(),
                n.config.showOnceEvery && window.localStorage.setItem(n.hideUntilKey(), (t = n.config.showOnceEvery,
                Date.now() + 24 * t * 60 * 60 * 1e3)),
                n.disable && n.disable()
            }
            ,
            this.form = e,
            this.config = new u(this.form.config.settings.modal)
        }
        var e, n, r;
        return e = t,
        (n = [{
            ...
            value: function() {
                ...
                this.configureLinks(),
                this.canDisplayOnce() && this.canDisplayOnDevice() && this.configureTrigger()
            }
        }, {
            key: "canDisplayOnce",
            value: function() {
            ...
            value: function() {
                ...
                w(document, ["a", "button"], 0, (function(e, n) {
                    var r = n.dataset;
                    (r && (r.svToggle || r.formkitToggle)) == t.form.config.uid && (e.preventDefault(),
                    t.show())
                }
                ))
            }
            ...
            value: function(t, e) {
                ...
                n.body.addEventListener("ckjs:guard:size", (function(t) {
                    ...
                    n.body.style.width = "".concat(t.detail.width, "px")
                }
                )),
                n.body.addEventListener("ckjs:guard:confirmed", (function(t) {
                    ...
                    e && e(null == t || null === (o = t.detail) || void 0 === o ? void 0 : o.visitor)
                }
                ), {
                    once: !0
                })
    ...
    var M = function() {
        function t(e) {
            ...
            ,
            this.form = e,
            this.config = new u(e.config.settings.slide_in)
        }
        var e, n, r;
        return e = t,
        (n = [{
    ...
    var U = function() {
        ...
        (n = [{
            key: "initialize",
            value: function() {
                this.form.hidden ? this.hide() : (this.form.resize(),
                setTimeout(this.form.visit, 2e3))
            }
        }, {
            key: "hide",
            value: function() {
    ...
    var H = function() {
        function t(e) {
            ...
            ,
            this.form = e,
            this.config = new u(e.config.settings.sticky_bar)
        }
        var e, n, r;
        return e = t,
        (n = [{
            ...
            value: function() {
                ...
                w(document, ["a", "button"], 0, (function(e, n) {
                    var r = n.dataset;
                    (r && r.formkitToggle) == t.form.config.uid && (e.preventDefault(),
                    t.show())
                }
                )),
                w(this.body, "[data-formkit-close]", 0, (function() {
    ...
    var Y = function() {
        function t(e) {
            ...
            this.form = e,
            this.button = this.form.body.querySelector(".formkit-tab-navigation"),
            this.tabsContainer = this.form.body.querySelector(".formkit-tabs-container"),
        ...
        (n = [{
            key: "initialize",
            value: function() {
                this.button && this.button.addEventListener("click", this.toggleTab),
                this.tabsContainer.style.height = "".concat(this.tabs[0].offsetHeight, "px"),
            ...
            value: function(t) {
                ...
                this.tabsContainer.style.transform = "translateY(-".concat(e, "px)"),
                this.tabsContainer.style.height = "".concat(this.tabs[1].offsetHeight, "px"),
                t.preventDefault()
            }
        }, {
            key: "toggleVisible",
    ...
    var lt = function() {
      ...
      , yt = function() {
        var t = ht();
        return window.localStorage.setItem(ft, t),
        t
    }
      , pt = function() {
    ...
    var gt = function() {
        function t(e) {
            ...
            this.update = function(t) {
                n.value = t,
                n.element.setAttribute("min-width", n.value)
            }
            ,
            this.element = e,
            this.interval = i || 100,
    ...
    function _t(t) {
        if (!window.__sv_forms)
            return null;
        for (var e = 0; e < window.__sv_forms.length; e++)
            if (window.__sv_forms[e].element == t)
                return window.__sv_forms[e];
        return null
    }
    function jt(t, e) {
    ...
    var Pt = function() {
        function t(e) {
                ...
                return s.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 3:
                            return e = t.sent,
                            t.next = 6,
                            fetch("".concat("https://app.convertkit.com", "/forms/").concat(n.config.id, "/visit"), {
                                method: "POST",
                                body: JSON.stringify({
                    ...
                    return s.a.wrap((function(t) {
                        for (; ; )
                            ...
                            case 3:
                                ...
                                o.append("token", r),
                                o.append("referrer", a),
                                o.append("host", document.location.href),
                                o.append("search", document.location.search),
                                o.append("user", pt()),
                                o.append("ckjs_version", "6"),
                                t.prev = 13,
                                c = fetch(i.action, {
                                    method: "POST",
                                    body: o,
                    ...
                    return s.a.wrap((function(t) {
                        for (; ; )
                            ...
                            case 6:
                                i = t.sent,
                                t.t0 = i.status,
                                t.next = "success" === t.t0 ? 10 : "quarantined" === t.t0 ? 12 : 14;
                                break;
                            case 10:
                                return n.success(i),
                                t.abrupt("break", 16);
                            case 12:
                                return n.quarantine(i),
                                t.abrupt("break", 16);
                            case 14:
                                return n.errors(i.errors),
                                t.abrupt("break", 16);
                            case 16:
                            case "end":
                                return t.stop()
            ...
            this.success = function(t) {
                var e;
                if (mt(n.config.uid),
                null !== (e = t.consent) && void 0 !== e && e.enabled)
            ...
            this.appendSuccessMessage = function(t) {
                if (!document.getElementById(n.config.uid)) {
                    ...
                    e.setAttribute("id", n.config.uid),
                    e.className = "formkit-alert formkit-alert-success",
                    e.dataset.element = "success",
                    e.dataset.group = "alert",
            ...
            this.body = e,
            this.hidden = !1,
            this.config = new at(_t(e)),
            this.recaptcha = new lt(this.config.recaptcha),
            this.format = new r[this.config.format](this),
            this.template = i[this.config.template] ? new i[this.config.template](this) : new G(this),
        ...
        (n = [{
            ...
            value: function() {
                if (!this.config.initialized) {
                    ...
                    this.resize = t.size,
                    vt(this.config.uid) && this.returnVisitor(),
      ...
      , Ct = {
        ...
        hubSpotOne: "form[class*=hsfc-Form]",
        hubSpottwo: "form[class*=hs-form]"
    };
    function It(t, e, n) {
    ...
    var Rt = function() {
        function t() {
            zt(this, t),
            this.trackedFormId = 0,
            this.targetSelectors = Object.values(Ct).join(", "),
            this.trackGenericForms(),
            this.trackMutationForms()
        }
        return qt(t, [{
                ...
                new MutationObserver((function(e) {
                    e.forEach((function(e) {
                        e.target.querySelectorAll(n).forEach((function(e) {
                            t.isMediavineGrowTarget(e) && t.trackMutationForms(e.shadowRoot, "form"),
                            t.trackAndCreateForm(e)
                        }
                        ))
                    }
            ...
            value: function(t) {
                this.skipForm(t) || (this.trackedFormId += 1,
                t.dataset.trackedFormId = this.trackedFormId,
                this.isOptinMonsterForm(t) ? new Ht(t) : new Nt(t))
            }
        }, {
      ...
      , Nt = function() {
        function t(e) {
            var n = this;
            zt(this, t),
            this.detectEmailInForm = function(t) {
                var e, r, i, o, a;
            ...
            this.body = e,
            this.accountId = St(),
            this.format = new U(this),
            console.log("new ThirdPartyForm", e),
            this.submitted = !1,
            this.guardAfterClose = !1,
            this.initialize.call(this)
        }
        return qt(t, [{
            key: "initialize",
            ...
            value: function(t) {
                ...
                console.log("email detected", r),
                r && this.format.guard("".concat("https://app.convertkit.com", "/recommendations/suggestions/third_party?email_address=").concat(encodeURIComponent(r), "&account_id=").concat(this.accountId))
            }
        }]),
        t
    }()
